...
function WatchPage() {
  ...
  console.log("Content Details Data:", contentDetails);
        ...
        {similarContent.length > 0 && (
          <div className="mt-12 max-w-5xl mx-auto relative">
            ...
            >
              ...
              />
              <ChevronLeft
                className="absolute top-1/2 -translate-y-1/2 left-2 w-8 h-8 opacity-0 group-hover:opacity-100 transition-all durtation-300 cursor-pointer bg-red-600 text-white rounded-full"
                onClick={scrollLeft}
              />
            </div>
          </div>
